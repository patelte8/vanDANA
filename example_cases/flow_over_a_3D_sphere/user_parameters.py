...
C_cw = Constant(0.35)                       	# Crosswind stabilization constant (As per R Codina : quadratic elements: 0.35, for linear elements: 0.7)
...
print_control = dict(
		...
		a = 0.5,   								# for printing variables and restart files
		b = 0.05,  								# for post processing quantities - text files
		c = 1,	 								# for simulation_wall_time text file
		d = 120,   								# for remeshing solid current-configuration mesh		
