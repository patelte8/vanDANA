...
problem_physics = dict(
		...
		solid_material = 'linearelastic',		# options: 1. neoHookean 2. linearelastic								
...
physical_parameters = dict(
		...
		nw = 0.45,								# Poissons ratio ... only for linearelastic (nw != 0.5, cannot be perfectly incompressible)
...
print_control = dict(
		...
		d = 0.1,   								# for remeshing solid current-configuration mesh		
		e = 0.02   								# for timestep_courant_no_stats text file	
	)
