...
// Plane 1
Point(9) = {x, 0.98333334, 0.16666667, 1.0};
Point(10) = {x, 0.98333334, 0.83333334, 1.0};
Point(11) = {y, 1.18333334, 0.16666667, 1.0};
Point(12) = {y, 1.18333334, 0.83333334, 1.0};

// Plane 2
Point(13) = {x, 1.01666667, 0.16666667, 1.0};
Point(14) = {x, 1.01666667, 0.83333334, 1.0};
Point(15) = {y, 1.21666667, 0.16666667, 1.0};
Point(16) = {y, 1.21666667, 0.83333334, 1.0};
...
Transfinite Curve {2, 4, 6, 11} = 81  Using Progression 1;
Transfinite Curve {3, 7, 1, 12} = 54 Using Progression 1;
